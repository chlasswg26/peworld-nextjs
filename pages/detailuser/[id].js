...
function DetailUser(props) {
  ...
  const sendMessage = () => {
    const body = {
      from: dataCompany.id,
      to: id,
      messageContent: `Hai ${dataUser.name} kami dari ${dataCompany.company_name} telah melihat profile kamu, dan kami tertarik untuk menawarkan pekerjaan di perusahaan kami sebagai web developer. Jika kamu bersedia silahkan hubungi no ini ${dataCompany.phone}`,
